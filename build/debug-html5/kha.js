...
Main.main = function() {
	kha_System.init({ title : "Project", width : 1024, height : 768},function() {
		kha_Assets.loadEverything(function() {
			...
			kha_Scheduler.addTimeTask($bind(Project1,Project1.update),0,0.016666666666666666);
		});
	});
};
Math.__name__ = true;
var Project = function() {
	this.poussin = kha_Assets.images.poussin;
};
...
Project.prototype = {
	...
	,render: function(framebuffer) {
		...
		framebuffer.get_g2().drawImage(this.poussin,500,300);
...
var kha_ImageList = function() {
	this.names = ["poussin"];
	this.poussinDescription = { files : ["poussin.png"], original_height : 64, type : "image", original_width : 64, name : "poussin"};
	this.poussinName = "poussin";
	this.poussin = null;
};
...
kha_ImageList.prototype = {
	poussin: null
	,poussinName: null
	,poussinDescription: null
	,poussinLoad: function(done) {
		kha_Assets.loadImage("poussin",function(image) {
			done();
		});
	}
	,poussinUnload: function() {
		this.poussin.unload();
		this.poussin = null;
	}
	,names: null
...
kha_Shaders.init = function() {
	...
	var data5 = Reflect.field(kha_Shaders,"painter_video_vertData");
	var bytes5 = haxe_Unserializer.run(data5);
	kha_Shaders.painter_video_vert = new kha_graphics4_VertexShader(kha_internal_BytesBlob.fromBytes(bytes5),"painter_video_vert");
